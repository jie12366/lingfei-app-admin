<template>
    <div class="app-container">
        ...
        <el-table v-loading="listLoading" :data="list" element-loading-text="Loading" border fit highlight-current-row>
            <el-table-column align="center" type="index" :index="indexMethod" width="180" />
            <el-table-column align="center" label="姓名" prop="name" width="200" />
            <el-table-column align="center" label="性别" prop="sex" width="180" />
            <el-table-column align="center" label="QQ" prop="qq" width="300" />
            <el-table-column align="center" label="部门" prop="depart" width="300" />
